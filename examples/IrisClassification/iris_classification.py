...
class IrisClassification(pl.LightningModule):
    ...
    def train_dataloader(self):
        train_loader = DataLoader(dataset=self.train_set, batch_size=8, num_workers=3)
        return train_loader

    def val_dataloader(self):
        validation_loader = DataLoader(dataset=self.val_set, batch_size=8, num_workers=3)
        return validation_loader

    def test_dataloader(self):
        test_loader = DataLoader(dataset=self.test_set, batch_size=8, num_workers=3)
        return test_loader
